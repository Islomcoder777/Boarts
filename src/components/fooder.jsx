import { apl, image, play, qr, sciticon, scitka } from "../img";
    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <img class="w-auto h-9" src={image} alt="" />

                <p class="text-base leading-relaxed text-gray-600 mt-7">Доступ к ранним релизам в приложении </p>
            ...
            <div>
                <p class="text-sm font-semibold tracking-widest text-gray-400 uppercase">Контакты</p>

                <ul class="mt-6 space-y-4">
                    <li>
                        <a href="#" title="" class="flex text-base text-white transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> 8 (800) 511-74-68  </a>
                    </li>

                    <li>
                        <a href="#" title="" class="flex text-base text-white transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Бесплатная горячая линия </a>
                    </li>

                    <li>
                        <a href="#" title="" class="flex text-base text-white transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Контактный Email </a>
                    </li>

                    <li>
                        <a href="#" title="" class="flex text-base text-white transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> info@brd.ru </a>
                    </li>
                </ul>
            </div>
